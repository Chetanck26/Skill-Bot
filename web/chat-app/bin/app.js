...
io.on('connection', socket=> {
    ...
    //to check if mail templet is working or not ----start node app-- and ---start ng serve--- then ---check your mail----
    // email_sender_obj.send_email(12121, "kajalchauhan.mscit.17@gmail.com");
